...
```bash
bash 02_Design/verification/common/frontend/run_abtb.sh
bash 02_Design/verification/common/frontend/run_direction.sh
bash 02_Design/verification/common/frontend/run_pair.sh
bash 02_Design/verification/common/frontend/run_canonical.sh
bash 02_Design/verification/common/frontend/run_steering.sh
bash 02_Design/verification/riscv/functional/run_all.sh
```
...
```bash
git diff --check
bash -n 02_Design/verification/riscv/functional/run_all.sh
bash -n 02_Design/verification/common/frontend/run_canonical.sh
bash -n 02_Design/verification/common/frontend/run_steering.sh
bash -n 02_Design/verification/riscv/performance/short/run_perf.sh
bash -n 02_Design/verification/riscv/performance/long/run_coe_perf.sh
```
