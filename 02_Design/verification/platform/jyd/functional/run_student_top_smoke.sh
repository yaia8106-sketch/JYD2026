...
DESIGN_DIR="$(cd "$VERIFICATION_DIR/.." && pwd)"
cd "$RISCV_TESTS_DIR"

RTL_DIR="$DESIGN_DIR/rtl"
JYD_PLATFORM_DIR="$DESIGN_DIR/platform/jyd"
CONTEST_RTL_DIR="$JYD_PLATFORM_DIR/readonly/rtl"
...
RTL_FILES="
    ...
    $JYD_PLATFORM_DIR/rtl/student_top.sv
    ...
    $SCRIPT_DIR/../tb/tb_student_top_smoke.sv
"
