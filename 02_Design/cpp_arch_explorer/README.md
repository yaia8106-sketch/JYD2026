...
cmake --build 02_Design/cpp_arch_explorer/build -j16
ctest --test-dir 02_Design/cpp_arch_explorer/build --output-on-failure
```
...
```bash
02_Design/cpp_arch_explorer/build/frontend_study \
    --delays 6,10 --jobs 6
```
...
```bash
02_Design/cpp_arch_explorer/build/fdq_study \
    --programs current,src0 \
    --delays 10 \
