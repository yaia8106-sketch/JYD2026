...
**Phase 0 仿真路径已完成（2026-05-03），进入 Phase 1 前准备。**

说明：本轮按用户要求暂不修改 Vivado 工程/IP，仅完成 RTL 64-bit IROM 数据口与 `riscv_tests` 仿真模型适配。Vivado IROM IP 64-bit 重配留到 FPGA/工程阶段处理。
