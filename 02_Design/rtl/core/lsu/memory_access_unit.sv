...
module memory_access_unit #(
    ...
    input  logic [11:0] ex_lookup_addr,
    ...
    input  logic [11:0] ex_s1_lookup_addr,
    ...
    output logic [ 9:0] cache_lookup_addr,
    ...
    wire [11:0] ex_lsu_lookup_addr = ex_use_s1_lsu
    ...
    assign cache_lookup_addr = ex_lsu_lookup_addr[11:2];
